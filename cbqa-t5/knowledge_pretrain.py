...
def main():
    ...
    def preprocess_batch(
        ...
        src = examples[src_column]
        tgt = examples[tgt_column]
        return src, tgt

    def preprocess_function(examples):
        inputs, targets = preprocess_batch(examples, src_column, tgt_column)
    ...
    def post_processing_function(
        ...
        references = [{"id": ex["id"], "answers": [ex[tgt_column]]} for ex in examples]
